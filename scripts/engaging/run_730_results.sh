...
COMMON_EXPORT+=",CEMENTITIOUS_SAMPLE_SEED=${CEMENTITIOUS_SAMPLE_SEED:-42}"
COMMON_EXPORT+=",SAMPLE_SEED=${SAMPLE_SEED:-42}"
...
COMMON_EXPORT+=",WEB_MAX_TOTAL_QUERIES=${WEB_MAX_TOTAL_QUERIES:-}"
COMMON_EXPORT+=",WEB_QUERIES_PER_NODE=${WEB_QUERIES_PER_NODE:-}"
