#!/bin/bash
# MIT Engaging — merge literature + web records (provenance preserved).
set -euo pipefail
...
python -m pipeline.cementitious.cluster merge-literature-web --output "$OUT"
echo "Literature/web merge complete"
