#!/bin/bash
# Submit retrieve array jobs for all carbon capture methodologies.
set -euo pipefail
...
for METHODOLOGY in amine_absorption membrane_separation calcium_looping oxyfuel_combustion cryogenic_capture mineralization direct_separation; do
